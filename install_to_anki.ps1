param(
    [string]$AddonFolderName = "speed_streak_v1_14"
)
...
Get-ChildItem -Path $source -Force | Where-Object {
    $_.Name -notin @("install_to_anki.ps1", "generate_web_assets.py", ".DS_Store", ".git", ".github", ".gitignore", "CHANGELOG.md", "LICENSE") -and
